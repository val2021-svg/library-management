...
public class Books {
    private SimpleStringProperty title, author, authorlastname, isbn, keyword1, keyword2, keyword3, keyword4, keyword5;
    private int firstpub;

    public Books(String title, String author, String authorlastname, String isbn, String keyword1, String keyword2, String keyword3, String keyword4, String keyword5, Integer firstpub) {
